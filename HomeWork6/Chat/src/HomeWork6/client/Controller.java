                ...
                try {
                    while (true) {
                        ...
                        if (str.startsWith("/authok")) {
                            setAuthorized(true);
                            String fileName = "log"+loginField.getText()+".txt";
                            ...
                            if (arrayList.size() > countRow) {
                                for (int i = arrayList.size()-countRow; i < arrayList.size(); i++) {
...
//            loginField.clear();
    ...
    public void trySignUp() {
        ...
        SignUpStage sUp = new SignUpStage(out);
        sUp.show();
    }
